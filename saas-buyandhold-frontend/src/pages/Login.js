    ...
    <div className="max-w-md mx-auto mt-8">
      <div className="bg-white rounded-lg shadow-md p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Acesse sua conta Buy & Hold</p>
        </div>
        ...
        <div className="mt-6">
          ...
          >
            Usar calculadora sem cadastro
          </Link>
          <p className="text-xs text-gray-500 mt-2 text-center">
            Funcionalidades limitadas • Não é possível salvar carteiras
          </p>
        </div>
      </div>
    </div>
