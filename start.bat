...
type saas-buyandhold-frontend\.env | findstr /v "^REACT_APP_API_URL=" | findstr /v "^REACT_APP_EMAILJS_PASSWORD_TEMPLATE_ID=" >> saas-buyandhold-frontend\.env.temp 2>nul
